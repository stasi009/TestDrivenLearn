...
class CustomObjContrastTest(unittest.TestCase):
    ...
    def testCollectionEqual_WithSpecialMethod(self):
        ...
        """
        list1 = [CustomObjContrastTest.WithSpecialMethodObj(1),CustomObjContrastTest.WithSpecialMethodObj(1)]
        list2 = [CustomObjContrastTest.WithSpecialMethodObj(1),CustomObjContrastTest.WithSpecialMethodObj(1)]
