...
class TestGenerator(unittest.TestCase):
    ...
    def testListActive(self):
        ...
        def mapper(n):
            # must use "global" keyword, otherwise, it will create a new variable with same name
    ...
    def testGeneratorLazy(self):
        ...
        self.assertEqual(0,sideeffect) # generator not invoked yet, so still no side effect
        
        self.assertEqual([1,4,9,16],list(agenerator))    
        self.assertEqual(4,sideeffect) # generator invoked, make effects
    ...
    def testUnableReuse(self):
        ...
        for x in generator:
            first_list.append(x)
        self.assertSequenceEqual(range(3),first_list)
